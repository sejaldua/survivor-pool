...
schedule = pd.read_csv("data/nfl_schedule_2025.csv")
...
df = pd.read_csv('data/team_week_win_prob.csv').set_index('Team').fillna(0)
print(df)
...
# prob_lp += x[('DEN', 'Week 1')] == 1 # example
# Solve
